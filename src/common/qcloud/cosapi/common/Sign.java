package common.qcloud.cosapi.common;
...
public class Sign {
	 ...
	 * 
	 * @param appId
	 *            Qcloud上申请的业务IDhttp://app.qcloud.com
	 * @param secret_id
	 *            Qcloud上申请的密钥id
	 * @param secret_key
	 *            Qcloud上申请的密钥key
	 ...
	 * @return 0表示成功
	 */
	public static int appSignOnce(String appId, String secret_id, String secret_key, String userid, String url,
			StringBuffer mySign) {
		return appSignBase(appId, secret_id, secret_key, 0, userid, url, mySign);
	}

	private static String appSignature(int appId, String secretId, String secretKey, long expired, String fileId,
			String bucketName) {
		...
		String plainText = "a=" + appId + "&k=" + secretId + "&e=" + expired + "&t=" + now + "&r=" + rdm + "&f="
				+ fileId + "&b=" + bucketName;
	...
	public static String appSignatureOnce(int appId, String secretId, String secretKey, String remotePath,
			String bucketName) {
