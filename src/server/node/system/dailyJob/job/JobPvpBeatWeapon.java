...
public class JobPvpBeatWeapon extends AbstractJob implements IJob {

	private static final long serialVersionUID = -3817908468833747820L;
	private WeaponType weaponType;

	public JobType jobType = JobType.PvpBeatWeapon;

	public JobPvpBeatWeapon() {
	}

	public JobPvpBeatWeapon(WeaponType weaponType) {
	...
	public JobCurrentStatus readCurrent(LangType lang) {
		...
		if (lang != null) {
			currentStatus.setNeedStr(jobMaking.getNum().toString(), Root.langSystem.getMessage(lang, "weapon_" + weaponType.asCode()));
		}
