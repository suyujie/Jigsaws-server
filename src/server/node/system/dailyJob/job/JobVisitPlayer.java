...
public class JobVisitPlayer extends AbstractJob implements IJob {

	private static final long serialVersionUID = 4826944919998057743L;

	public JobType jobType = JobType.VisitPlayer;

	public JobVisitPlayer() {
	}
