...
public class JobXuLiKill extends AbstractJob implements IJob {

	private static final long serialVersionUID = -5278686731856437959L;

	public JobType jobType = JobType.XuLiKill;

	public JobXuLiKill() {
	}

	public void doJob(int xuliKill) {

		if (status == 0) {//没完成的
			completedNum += xuliKill;
