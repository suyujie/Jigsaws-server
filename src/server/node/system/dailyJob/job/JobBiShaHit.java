...
public class JobBiShaHit extends AbstractJob implements IJob {

	private static final long serialVersionUID = 1178016068382220402L;

	public JobType jobType = JobType.BiShaHit;

	public JobBiShaHit() {
	}

	public void doJob(int biSha) {
		if (status == 0) {//没完成的
			completedNum += biSha;
