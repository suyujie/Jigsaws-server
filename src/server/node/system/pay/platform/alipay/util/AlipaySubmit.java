package server.node.system.pay.platform.alipay.util;
...
import server.node.system.pay.platform.alipay.sign.RSA;
import server.node.system.pay.platform.alipay.util.httpClient.HttpProtocolHandler;
import server.node.system.pay.platform.alipay.util.httpClient.HttpRequest;
import server.node.system.pay.platform.alipay.util.httpClient.HttpResponse;
import server.node.system.pay.platform.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW + "_input_charset=" + AlipayConfig.input_charset + "\" method=\""
				+ strMethod + "\">");
