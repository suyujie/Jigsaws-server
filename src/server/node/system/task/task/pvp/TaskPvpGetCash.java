...
public class TaskPvpGetCash extends AbstractTask implements ITask {

	private static final long serialVersionUID = -6304902584653939282L;

	public TaskPvpGetCash() {
		super(TaskType.PvpGetCash);
	}

	public void doTask(int cash) {
		completedNum += cash;
