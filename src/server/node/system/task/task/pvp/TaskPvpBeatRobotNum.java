...
public class TaskPvpBeatRobotNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = -4247361794653238260L;

	public TaskPvpBeatRobotNum() {
		super(TaskType.PvpBeatRobotNum);
	}

	public void doTask(Player player) {
		completedNum = player.getPlayerStatistics().getPvpBeatRobotCount();
