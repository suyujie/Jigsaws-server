...
public class TaskPvpBeatQuality4RobotNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = -6372972543044619088L;

	public TaskPvpBeatQuality4RobotNum() {
		super(TaskType.PvpBeatRobotQuality4Num);
	}
