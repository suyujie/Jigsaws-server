...
public class TaskPvpBeatQuality2RobotNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = 1839189635589697493L;

	public TaskPvpBeatQuality2RobotNum() {
		super(TaskType.PvpBeatRobotQuality2Num);
	}
