...
public class TaskPvpBeatWeapon2RobotNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = -4135382155607109495L;

	//	PvpBeatRobotWeapon2Num(21), //	21	重击炼狱			多人游戏中，摧毁N个重击机器人
	public TaskPvpBeatWeapon2RobotNum() {
		super(TaskType.PvpBeatRobotWeapon2Num);
	}
