...
public class TaskAttackWinNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = 4288327910896811450L;

	public TaskAttackWinNum() {
		super(TaskType.AttackWinNum);
	}

	public void doTask(Player player) {
		completedNum = player.getPlayerStatistics().getPvpAttackWinCount();
