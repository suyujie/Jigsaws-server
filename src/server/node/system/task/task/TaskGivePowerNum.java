...
public class TaskGivePowerNum extends AbstractTask implements ITask {

	private static final long serialVersionUID = -2119271664740570971L;

	public TaskGivePowerNum() {
		super(TaskType.GivePowerNum);
	}
