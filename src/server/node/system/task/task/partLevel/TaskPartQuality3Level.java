...
public class TaskPartQuality3Level extends AbstractTask implements ITask {

	private static final long serialVersionUID = -1875814931343216870L;

	public TaskPartQuality3Level() {
		super(TaskType.PartQuality3Level);
	}
