...
public class TaskPaintPartQuality3Num extends AbstractTask implements ITask {

	private static final long serialVersionUID = 8497810000705322731L;

	public TaskPaintPartQuality3Num() {
		super(TaskType.PaintPartQuality3Num);
	}
