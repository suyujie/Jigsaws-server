...
public class TaskPaintPartQuality2Num extends AbstractTask implements ITask {

	private static final long serialVersionUID = -428284541298990825L;

	public TaskPaintPartQuality2Num() {
		super(TaskType.PaintPartQuality2Num);
	}
