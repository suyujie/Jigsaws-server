...
public class TaskWinWithWeapon1Num extends AbstractTask implements ITask {

	private static final long serialVersionUID = -3964074907161361886L;

	public TaskWinWithWeapon1Num() {
		super(TaskType.WinWithWeapon1Num);
	}
