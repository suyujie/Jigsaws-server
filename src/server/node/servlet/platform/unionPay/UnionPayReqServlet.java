...
@WebServlet("/unionpay/pay_req")
public class UnionPayReqServlet extends AbstractAction {

	private static final long serialVersionUID = -1956043055048622206L;

	private static final Logger logger = LogManager.getLogger(UnionPayReqServlet.class);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			SystemResult result = Root.paySystem.unionPayCreateOrder(player, rechargePackageId, orderId, coinType);
			...
			logger.info("UnionPayReqServlet receive msg END");
		} catch (Exception e) {
